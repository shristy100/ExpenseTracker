...
def search_expenses(request):
    if request.method == 'POST':
        ...
        expenses = Addmoney_info.objects.filter(
            add_money__istartswith=search_str, owner=request.user) | Expense.objects.filter(
            quantity__istartswith=search_str, owner=request.user) | Expense.objects.filter(
